    ...
    <div class="page">
      ...
      <div class="layout">
        ...
        <div class="panel">
              ...
              <tr><td>Worker</td><td>Background service</td><td>Parses uploaded files into PostgreSQL after upload completion.</td></tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="operations" class="panel">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr><td>Worker</td><td>Keep the worker running with memory flags in deployed environments.</td><td>Uploads complete only after the worker parses files into PostgreSQL.</td></tr>
