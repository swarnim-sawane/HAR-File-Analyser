...
Large-file validation must be planned separately because it can consume Object Storage capacity, worker memory, queue time, and PostgreSQL storage.
...
| High-entry | Many small entries | PostgreSQL batch insert and pagination behavior |
