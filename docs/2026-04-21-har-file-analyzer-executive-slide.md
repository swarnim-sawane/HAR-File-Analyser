...
## Tools & Technologies
- React/TypeScript frontend, Express/TypeScript backend, Oracle-backed worker processing/runtime state, Oracle JSON persistence, and Oracle Code Assist-powered AI insights.
