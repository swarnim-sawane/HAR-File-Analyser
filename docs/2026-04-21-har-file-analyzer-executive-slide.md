...
## Tools & Technologies
- React/TypeScript frontend, Express/TypeScript backend, BullMQ worker-based processing, MongoDB, Redis, OCI Object Storage for hosted artifacts, and optional OpenAI-powered AI insights.
