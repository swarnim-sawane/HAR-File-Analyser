// src/components/ConsoleLogAiInsights.tsx
import React, { useEffect, useState } from 'react';
import { ConsoleLogFile } from '../types/consolelog';
import { useConsoleLogInsights } from '../hooks/useConsoleLogInsights';
import { InsightFinding, InsightHealth } from '../hooks/useInsights';
import './AiInsights.css'; // reuse the same stylesheet
  ...
  if (isGenerating) {
    return (
      <div className="ai-insights-loading">
        ...
        <p className="ai-insights-stage-msg">OCA is analyzing your console log...</p>
  ...
  if (!insights) {
    return (
      <div className="ai-insights-empty">
        ...
        <h2>AI Insights</h2>
        <p>Intelligent diagnostics for your console log — errors, warnings, patterns &amp; fixes.</p>
        <button className="ai-insights-generate-btn" onClick={generate}>
    ...
    <div className="ai-insights">
      ...
      {insights.detectedProducts && insights.detectedProducts.length > 0 && (
        <div className="ai-insights-products-row">
          <span className="ai-insights-products-label">Detected:</span>
